...
public class Update<Implementations>  extends JFrame{
	...
	public Update() {
		...
		button1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				emp.setAddress(field4.getText());
				
				Implementions implementations = new Implementions();
				implementations.updateEmp(emp);
